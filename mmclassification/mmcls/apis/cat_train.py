...
from mmcls.core import (DADistEvalHook, DistOptimizerHook, DAEvalHook, OfficeEvalHook,
                        Fp16OptimizerHook)
from mmcls.datasets import build_dataloader, build_dataset, build_categorical_dataloader
from mmcls.utils import get_root_logger, convert_splitnorm_model


def cat_set_random_seed(seed, deterministic=False):
    """Set random seed.
...
def cat_train_model(model,
    ...
    data_loaders = [
        build_categorical_dataloader(
            ds,
            cfg.data.class_per_iter,
