...
def main():
    ...
    features_s = torch.from_numpy(np.vstack(pickle.load(open('features_t.pkl', 'rb'))))
    mlp_features_s = torch.from_numpy(np.vstack(pickle.load(open('mlp_features_t.pkl', 'rb'))))
    results_s = torch.from_numpy(np.vstack(pickle.load(open('results_t.pkl', 'rb'))))
    label_s = torch.from_numpy(pickle.load(open('gt_labels_t.pkl', 'rb')))
    features_t = torch.from_numpy(np.vstack(pickle.load(open('features_s.pkl', 'rb'))))
    mlp_features_t = torch.from_numpy(np.vstack(pickle.load(open('mlp_features_s.pkl', 'rb'))))
    results_t = torch.from_numpy(np.vstack(pickle.load(open('results_s.pkl', 'rb'))))
    label_t = torch.from_numpy(pickle.load(open('gt_labels_s.pkl', 'rb')))
